...
function isSummative(theUrl){
    return new Promise(function (resolve, reject){
        ...
        request({
            uri: theUrl + "/info",
            headers: {
                'Authorization': 'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VySWQiOiIzOTk4NTc0MyIsInNjaG9vbElkIjoiNTI1Mjk4Mjc3IiwibmFtZXNwYWNlIjoic2Nob29sb2d5IiwiaWF0IjoxNjc1NTU3MTY4LCJleHAiOjE2NzU1Nzg3NjgsImlzcyI6ImFwcC5zY2hvb2xvZ3kuY29tIn0.yM-onpAgymuEyotl3-UDOZYecTYOUnmWyKrRKV9ynes',
                ...
                Formative = formKeywords.some(substring=>body.includes(substring));
...
module.exports = { sortTwoWeeks, getAssignments, cacheAssignments };
